class Dagangan:
    ...
    def __init__(self, nama, stok, harga):  # Gunakan __init__ bukan _init_
        self.__nama = nama
        self.__stok = stok
        self.__harga = harga
        Dagangan.jumlah_barang += 1
        Dagangan.list_barang.append((self.__nama, self.__stok, self.__harga))  # Perbaiki penamaan variabel
    ...
    def __del__(self):  # Gunakan __del__ bukan _del_
        Dagangan.jumlah_barang -= 1
